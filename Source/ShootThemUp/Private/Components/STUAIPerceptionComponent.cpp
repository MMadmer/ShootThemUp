...
AActor* USTUAIPerceptionComponent::GetClosestEnemy() const
{
	...
	const auto PawnHealthComponent = STUUtils::GetSTUPlayerComponent<USTUHealthComponent>(Pawn);
	if (!PawnHealthComponent || PawnHealthComponent->IsDead()) return nullptr;
